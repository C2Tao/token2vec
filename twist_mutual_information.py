...
def obj_trans(inputs):
    ...
    return 1*trans+1*(-tot_entro)+1*(ind_entro)
...
def obj_final(inputs):
    #trans_err, entro_err, recon_err = inputs
    #return trans_err*0.01+entro_err*1+recon_err*1
...
#err_entro = merge([p,c], mode=obj_trans, output_shape =  shape_final, name = 'err_entro')
print p
